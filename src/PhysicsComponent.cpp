...
{
    world = JunkDragonGame::instance->world;
}

PhysicsComponent::~PhysicsComponent() {
    JunkDragonGame::instance->deregisterPhysicsComponent(this);
...
void PhysicsComponent::setAngularVelocity(float rotation){
...
void PhysicsComponent::moveTo(glm::vec2 pos) {
    ...
    setLinearVelocity(delta*(1/JunkDragonGame::timeStep));
}
